...
talk *[The Last Programming Language](https://youtu.be/P2yr-3F6PQo)*. He
...
*\"red green refactor\"* method to the letter. Despite all the benefits
...
video on this titled *\"[À la Carte
Polymorphism](https://lambdaisland.com/episodes/a-la-carte-polymorphism-1)\"*
that I\'ll probably need to keep re-watching.

### Encapsulation

Stuart Sierra made a great video talking about this in his talk
*\"[Components: Just Enough Structure](https://youtu.be/13cmHf_kt-Q)\"*.
